...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
	...
	<p class="text-center mt-3">
		...
		Temporibus, quos, voluptates, quae, quod, quibusdam <br> dolore commodi repudiandae voluptatem
  ...
  <div class="container">
	<div class="row justify-content-between align-items-center">
		<div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
			...
			<p>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit.
				Temporibus, quos, voluptates, quae, quod, quibusdam dolore commodi repudiandae voluptatem
				tenetur consequuntur et similique asperiores.
			</p>
		</div>
