...
- Chuyển toàn bộ sang CSS thuần
- Chỉ sửa trong file tôi gửi
- Nếu phần nào phụ thuộc file khác → giữ nguyên, không đụng vào
- Không thay đổi logic code
- Trả về code hoàn chỉnh trong 1 block, có thể chạy ngay
