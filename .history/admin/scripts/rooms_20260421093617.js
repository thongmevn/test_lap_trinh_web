// Modal functions - thay thế cho Bootstrap JS
...
function add_room() {
  ...
  xhr.onload = function () {
    closeModal("add-room"); // Đóng modal bằng hàm custom
...
function edit_details(id) {
  ...
  xhr.onload = function () {
    ...
    edit_room_form
      .querySelectorAll('input[name="facilities[]"]')
      .forEach((el) => {
    ...
    openModal("edit-room"); // Mở modal edit
  };
...
function submit_edit_room() {
  ...
  xhr.onload = function () {
    closeModal("edit-room"); // Đóng modal bằng hàm custom
...
function room_images(id, rname) {
  ...
  xhr.onload = function () {
    ...
    openModal("room-images"); // Mở modal images
  };
