<?php 
  ...
  if(isset($_POST['user_analytics']))
  {
    ...
    if($condition==""){
      $sql_reviews = "SELECT COUNT(sr_no) AS `count` FROM `rating_review`";
      $sql_queries = "SELECT COUNT(sr_no) AS `count` FROM `user_queries`";
      $sql_reg = "SELECT COUNT(id) AS `count` FROM `user_cred`";
    }
    else{
