...
<tr>
  ...
  <td>
    <b>".number_format((int)$row['total_charge'])." VND</b>
  </td>
  ...
  <td>
    <span style="
      ...
      color:white;
      background:".(
        $status_class=='paid' ? 'green' :
        ($status_class=='pending' ? 'orange' : 'red')
      ).";
    ">
      $status_text
    </span>
  ...
  <td>
    <button onclick=\"set_charge_status($row[id],'paid')\"
      style="
        background:black;
        color:white;
        border:none;
    ...
    <button onclick=\"set_charge_status($row[id],'waived')\"
      style="
        background:white;
        color:black;
    ...
    <button onclick='delete_charge($row[id])'
      style="
        background:red;
        color:white;
        border:none;
