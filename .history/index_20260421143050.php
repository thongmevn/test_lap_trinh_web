...
<head>
    ...
    <!-- <link rel="stylesheet" href="../css/rooms_ajax.css"> -->
...
<body class="bg-light">
    ...
    <div class="container">
      ...
      ?>
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="rooms.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Tìm hiểu thêm
                    >>></a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
      ...
      ?>
            ...
            <div class="col-lg-12 text-center mt-5">
                <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Tìm hiểu thêm
                    >>></a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
          ...
          ?>
                ...
                <div class="p-4 rounded">
                    <a href="about.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Tìm hiểu thêm
                        >>></a>
                </div>
            </div>
        </div>
