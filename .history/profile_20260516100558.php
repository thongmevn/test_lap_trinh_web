  ...
  ?>
    ...
    profile_form.addEventListener('submit', function(e) {
        ...
        xhr.onload = function() {
            ...
            } else if (this.responseText == 'inv_size') { // Thêm cái này để bắt lỗi dung lượng
                alert('error', "Ảnh tải lên không được vượt quá 2MB!");
            } else if (this.responseText == 'upd_failed') {
                alert('error', "Tải hình ảnh thất bại!");
            } else if (this.responseText == 0) {
                alert('error', "Cập nhật thất bại!");
            } else if (this.responseText == 1) { // 1 là thành công
                window.location.href = window.location.pathname;
            } else {
                // ĐÂY LÀ ĐOẠN HIỂN THỊ LỖI BỊ GIẤU
                console.log(this.responseText);
                window.alert("Lỗi từ máy chủ: \n" + this.responseText);
            }
        }
        xhr.send(data);
    });
