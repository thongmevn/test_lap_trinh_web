...
<body class="bg-light">
  ...
  ?>
    ...
    profile_form.addEventListener('submit', function(e) {
        ...
        xhr.onload = function() {
            // Dùng .trim() để cắt bỏ các khoảng trắng/xuống dòng thừa từ PHP
            ...
            if (res == 'inv_img') {
                ...
                // THÀNH CÔNG! Tự động tải lại trang để hiển thị ảnh mới
                alert('success', 'Cập nhật ảnh thành công!');
                setTimeout(() => {
                    window.location.href = window.location.pathname;
                }, 1000); // Chờ 1 giây để người dùng thấy thông báo xanh rồi mới load trang
            } else {
