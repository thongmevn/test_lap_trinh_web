    ...
    <div class="container">
        <div class="row justify-content-between align-items-center">
            <div class="col-lg-6 col-md-5 mb-4 order-lg-1 order-md-1 order-2">
                ...
                <p>
                    Chúng em xin được bày tỏ lòng biết ơn đến các thầy, cô trường Đại học Nguyên Tất Thành khoa Công
                    Nghệ Thông Tin đã giúp đỡ, hỗ trợ nhiệt tình trong suốt quá trình học. <br><br>
                    Đặc biệt gửi lời cảm ơn đến cô Nguyễn Thị Hoài Thu đã trực tiếp giúp đỡ, hỗ trợ, hướng dẫn em hoàn
                    thành khóa luận này.
                </p>
            </div>
