...
<body class="bg-light">
  ...
  ?>
    ...
    function updateThumbnailActive() {
        const carousel = bootstrap.Carousel.getInstance(document.getElementById('roomCarousel'));
        if (carousel) {
            const activeIndex = carousel._getItemIndex(carousel._element.querySelector('.carousel-item.active'));
