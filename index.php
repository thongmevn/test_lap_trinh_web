...
<body class="bg-light">
        ...
        <form>
          ...
          <div class="modal-body">
            <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
              Note: Your details must match with your ID (Personal ID card, Passport, Driving license, etc.)
      ...
      <div class="swiper-wrapper mb-5">
        <div class="swiper-slide bg-white p-4">
          ...
          <p>
            ...
            Labore qui dignissimos iste, rerum quo, magnam impedit exercitationem magni delectus eveniet in ipsum eius atque doloribus nihil corporis aliquam, nemo eum.
          </p>
          <div class="rating">
            <i class="bi bi-star-fill text-warning"></i>
            <i class="bi bi-star-fill text-warning"></i>
  ...
  <div class="container-fluid bg-white mt-5">
    <div class="row">
      <div class="col-lg-4 p-4">
        ...
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing elit.
          Numquam dolorum cupiditate nostrum delectus adipisci enim saepe consequuntur nobis praesentium? Soluta mollitia quod ullam sequi nulla natus voluptates reprehenderit, molestias ipsa.
        </p>
      </div>
      <div class="col-lg-4 p-4">
  ...
  <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developd by Holden</h6>
