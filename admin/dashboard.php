...
<head>
    ...
    <!-- Dashboard styles moved to admin/css/common.css -->
...
?>
    ...
    <div id="main-content">
        ...
        ?>
                ...
                <div class="row mb-4">
                    <div class="col-3">
                        <a href="new_bookings.php">
                            <div class="card dash-card dash-success">
                    ...
                    <div class="col-3">
                        <a href="refund_bookings.php">
                            <div class="card dash-card dash-warning">
                    ...
                    <div class="col-3">
                        <a href="user_queries.php">
                            <div class="card dash-card dash-info">
                                <h6>Số tin nhắn</h6>
                ...
                <div class="row mb-3">
                    <div class="col-3">
                        <div class="card dash-card dash-primary">
                    ...
                    <div class="col-3">
                        <div class="card dash-card dash-danger">
